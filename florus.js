...
function lunar (D) {
	// 农历已支持到2026年底，2027年之前我再更新一下
	const y = CD.getFullYear(), L = {'2025': [-1, 28, 58, 87, 117, 146, 175, 205, 234, 264, 293, 323, 353], '2026': [-12, 18, 47, 77, 106, 136, 165, 194, 224, 253, 282, 312, 342]}, Lx = {'2025': ['腊', '正', '二', '三', '四', '五', '六', '闰六', '七', '八', '九', '十', '冬'], '2026': ['冬', '腊', '正', '二', '三', '四', '五', '六', '七', '八', '九', '十', '冬'],};
	let i = L[y].length - 1;
	while (D < L[y][i] + 1) {i--;}
